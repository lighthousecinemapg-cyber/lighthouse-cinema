    ...
    <div style={{ display: 'grid', gap: 20, gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))' }}>
      {events.map((e, i) => (
        <article key={e.id} style={{
          background: '#141414', border: '1px solid #2a2a2a', borderRadius: 16, overflow: 'hidden',
          display: 'flex', flexDirection: 'column',
        }}>
          <div style={{
            background: `linear-gradient(135deg,#1a1a1a,#2a1f0a)`, height: 160,
          ...
          <div style={{ padding: 20, display: 'flex', flexDirection: 'column', gap: 8, flex: 1 }}>
            ...
            <div style={{ marginTop: 'auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', paddingTop: 12 }}>
              ...
              <Link href={`/events/${e.id}`} style={{
                background: '#d4af37', color: '#0a0a0a', padding: '10px 18px', borderRadius: 999,
