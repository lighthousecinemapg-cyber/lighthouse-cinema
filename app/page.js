...
'use client';
// Rebuild trigger v2
import { useState, useEffect } from 'react';hz
        ...
        {times.map(t => (
          movie ? (
            <a key={t} href={getTicketLink(movie, t)} target="_blank" rel="noopener noreferrer"
              ...
              {t} <span style={{ fontSize: '0.7rem', opacity: 0.7 }}>Ã°ÂÂÂÃ¯Â¸Â</span>
            </a>
          ) : (
            <span key={t} style={{
              background: 'rgba(212,175,55,0.12)', color: cream,
...
function PayItForwardMini() {
  return (
    <a href={SQUARE_LINKS.payItForward} target="_blank" rel="noopener noreferrer"
      ...
      Ã°ÂÂÂ Pay It Forward Ã¢ÂÂ Buy a ticket for someone who needs a night out
    </a>
  );
}
            ...
            {['Wed', 'Thu', 'Fri', 'Sat', 'Sun'].map(day => {
              ...
              return (
                ...
                <div style={{ fontSize: '0.78rem', color: cream, lineHeight: 2 }}>
                  <a href={SQUARE_LINKS.general} target="_blank" rel="noopener" style={{ color: gold, fontWeight: 600, marginBottom: 2, display: 'block', textDecoration: 'none' }}>Devil Wears Prada 2</a>
                  {day === 'Sat' ? <div style={{ color: 'rgba(240,233,215,0.4)', fontStyle: 'italic' }}>—</div> : <a href={SQUARE_LINKS.general} target="_blank" rel="noopener" style={{ display: 'block', color: cream, textDecoration: 'none' }}>12:30 · 2:30 · 5 · 7:30</a>}
                  <a href="https://square.link/u/35dAPUL4" target="_blank" rel="noopener" style={{ color: gold, fontWeight: 600, marginTop: 6, marginBottom: 2, display: 'block', textDecoration: 'none' }}>Project Hail Mary</a>
                  {day === 'Wed' ? <a href="https://square.link/u/35dAPUL4" target="_blank" rel="noopener" style={{ display: 'block', color: cream, textDecoration: 'none' }}>4 · 7</a> : day === 'Thu' ? <a href="https://square.link/u/35dAPUL4" target="_blank" rel="noopener" style={{ display: 'block', color: cream, textDecoration: 'none' }}>1 · 4 · 7</a> : <div style={{ color: 'rgba(240,233,215,0.4)', fontStyle: 'italic' }}>—</div>}
                  <a href="https://square.link/u/ovzTqZKH" target="_blank" rel="noopener" style={{ color: gold, fontWeight: 600, marginTop: 6, marginBottom: 2, display: 'block', textDecoration: 'none' }}>Grease</a>
                  {day === 'Fri' || day === 'Sat' ? <a href="https://square.link/u/ovzTqZKH" target="_blank" rel="noopener" style={{ display: 'block', color: cream, textDecoration: 'none' }}>7 PM</a> : <div style={{ color: 'rgba(240,233,215,0.4)', fontStyle: 'italic' }}>—</div>}
                  <a href={SQUARE_LINKS.general} target="_blank" rel="noopener" style={{ color: gold, fontWeight: 600, marginTop: 6, marginBottom: 2, display: 'block', textDecoration: 'none' }}>The Sheep Detectives</a>
                  {day === 'Wed' || day === 'Thu' ? <div style={{ color: 'rgba(240,233,215,0.4)', fontStyle: 'italic' }}>Starting Fri</div> : <a href={SQUARE_LINKS.general} target="_blank" rel="noopener" style={{ display: 'block', color: cream, textDecoration: 'none' }}>1 · 4 · 7</a>}
              );
            })}
          </div>
        </div>
