    ...
    <html lang="en">
      ...
      <body>
        ...
        <footer className="site-footer">
          ...
          <a href="https://www.facebook.com/lighthousecinema4/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" style={{color:'#D4AF37',fontSize:'28px',textDecoration:'none'}}>
          ...
          <a href="https://www.instagram.com/lighthousecinemas4/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" style={{color:'#D4AF37',fontSize:'28px',textDecoration:'none'}}>
          ...
          <a href="https://www.tiktok.com/@lighthousecinemas4" target="_blank" rel="noopener noreferrer" aria-label="TikTok" style={{color:'#D4AF37',fontSize:'28px',textDecoration:'none'}}>
          ...
          <a href="https://www.yelp.com/biz/lighthouse-cinemas-pacific-grove" target="_blank" rel="noopener noreferrer" aria-label="Yelp" style={{color:'#D4AF37',fontSize:'28px',textDecoration:'none'}}>
