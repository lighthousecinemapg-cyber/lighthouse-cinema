...
// ================================================================
// Generic transactional email sender (used by contact + inquiry flows).
// Throws (with err.code === 'NO_SMTP') when SMTP is not configured so
// callers can capture/log the inquiry instead of losing it.
// ================================================================
