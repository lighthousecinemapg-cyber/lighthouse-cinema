  ...
  },
{
  ...
  ,
  {
    ...
    ticketPrice: 20,
    bookingUrl: 'https://square.link/u/di4RlSb0'
  },
  {
    ...
    category: 'movie',
    ticketPrice: 10,
    ticketUrl: 'https://square.link/u/di4RlSb0',
  },
  {
    id: 'evt-art-fusion-concert',
    title: 'Art & East-Meets-West Fusion Concert',
    description: 'Abstract art by Shagufta Khan and Nate Stapleton, East-meets-West fusion music by the Echoes Eternal Collective, live DJ from the Guam Show (KHDC 90.9 FM), surprise pop-up sketch by Edge Lorenzo (Disney veteran animator). Wine and light refreshments served.',
    date: '2026-05-23',
    time: '17:00',
    venue: 'Lighthouse Cinema',
    category: 'live-entertainment',
    ticketPrice: 15,
    ticketUrl: 'https://square.link/u/TREEYNkF',
    bookingUrl: 'https://square.link/u/TREEYNkF',
    active: true
  },
  {
    id: 'evt-edward-jones',
...
export function getLocalEvents() {
  ...
  return events.filter(e => e.active && e.date >= today);
}
