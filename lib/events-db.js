...
// For MVP ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ events are stored in memory and can be managed via admin
// ================================================================
...
let events = [
  ...
  },
  {
    ...
    description: 'Karma Sunday ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ brunch, a classic film, and community. The perfect Pacific Grove morning.',
    date: '2026-04-12',
    time: '11:00',
    venue: 'Main Auditorium',
    ticketPrice: 25,
